...
public class TwoWheelerStrategy implements PricingStrategy{
    ...
    public static void setPriceForFirst3Hour(int priceForFirst3Hour) {
        TwoWheelerStrategy.priceForFirst3Hour = priceForFirst3Hour;
    }
    ...
    public static void setPriceForExtraHour(int priceForExtraHour) {
        TwoWheelerStrategy.priceForExtraHour = priceForExtraHour;
    }   
